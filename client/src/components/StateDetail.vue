...
export default {
	...
	data() {
		return {
			...
			url: 'http://{s}.tile.osm.org/{z}/{x}/{y}.png', //template url for map
			zoom: 2, //determines how close the map renders
			center: [44, -103],  //Initializes the map at the geographic center of the US
			bounds: null
		}
	},
	mounted() {
